<script>
    import { deleteWorkshop, markWorkshopComplete } from "$lib/firebase-setup";
        ...
        <div  class="flex justify-between items-center">
          <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
            <button
              ...
              on:click={() => deleteWorkshop(docId)}>Delete</button
            >
          </dd>
          <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
            <label class="inline-flex items-center cursor-pointer">
              ...
              >
              <input type="checkbox" value="" class="sr-only peer" on:change={(e) => markWorkshopComplete(docId, e.target.checked)} checked={completed}/>
              <div
